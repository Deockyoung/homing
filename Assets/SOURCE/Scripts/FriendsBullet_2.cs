...
public class FriendsBullet_2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (FindEnemy.currentHitObjectList.Count > 0)
        {
            ...
            print("currentHitObjectList[0]:" + FindEnemy.currentHitObjectList[0]);
        }
        ...
        xHoming = forwardSpeedCurve.Evaluate(FowardCurrentTime);
        dir.x += xHoming;
